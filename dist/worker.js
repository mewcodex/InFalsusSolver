import {solve,maximizeStats,solveConstrained} from './solver.js?v=snapshot-22894';
...
self.onmessage=async({data})=>{try{
 ...
 const published=await fetch('solution-archive-data.json?v=snapshot-22894').then(r=>r.ok?r.json():{}).catch(()=>({}));
