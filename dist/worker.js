import {solve,maximizeStats,solveConstrained} from './solver.js?v=snapshot-93928-refresh';
...
self.onmessage=async({data})=>{try{
 ...
 const published=await fetch('solution-archive-data.json?v=snapshot-93928-refresh').then(r=>r.ok?r.json():{}).catch(()=>({}));
