import {solve,maximizeStats,solveConstrained} from './solver.js?v=archive-20260919';
...
self.onmessage=async({data})=>{try{
 ...
 const published=await fetch('solution-archive-data.json?v=20260919').then(r=>r.ok?r.json():{}).catch(()=>({}));
