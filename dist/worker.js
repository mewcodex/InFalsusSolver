import {solve,maximizeStats,solveConstrained} from './solver.js?v=snapshot-114825';
...
self.onmessage=async({data})=>{try{
 ...
 const published=await fetch('solution-archive-data.json?v=snapshot-114825').then(r=>r.ok?r.json():{}).catch(()=>({}));
